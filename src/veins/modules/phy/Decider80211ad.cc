...
simtime_t Decider80211ad::processNewSignal(AirFrame* msg)
{
...
int Decider80211ad::getSignalState(AirFrame* frame)
{
...
DeciderResult* Decider80211ad::checkIfSignalOk(AirFrame* frame)
{
    ...
    double payloadBitrate = get11adDatarate(static_cast<MCS>(frame11p->getMcs()));
...
bool Decider80211ad::cca(simtime_t_cref time, AirFrame* exclude)
{
...
simtime_t Decider80211ad::processSignalEnd(AirFrame* msg)
{
...
void Decider80211ad::setChannelIdleStatus(bool isIdle)
{
...
void Decider80211ad::changeFrequency(double freq)
{
    centerFrequency = freq;
}

double Decider80211ad::getCCAThreshold()
{
    return 10 * log10(ccaThreshold);
}

void Decider80211ad::setCCAThreshold(double ccaThreshold_dBm)
{
    ccaThreshold = pow(10, ccaThreshold_dBm / 10);
}

void Decider80211ad::setNotifyRxStart(bool enable)
{
    notifyRxStart = enable;
}

void Decider80211ad::switchToTx()
{
    if (currentSignal.first != 0) {
        ...
        if (allowTxDuringRx) {
            ...
            throw cRuntimeError("Decider80211ad: mac layer requested phy to transmit a frame while currently receiving another");
        }
    }
}
